...
def run(args):
    ...
    parms = config.get_input_parms(args) #Per prendere i parametri da linea di comando
    ...
    VG_trj = VarianceGamma_process(S0, eta, theta, nu, steps, N) #Underlying trajectories
